...
#### Random Matters: A Sampling Distribution for a Proportion

```{r}
# XX NH need baby sample data?
```
...
Here, the `do()` function finds the `favstats()` of a sample of 10 `BodyFat` weights 1,000 times. 
