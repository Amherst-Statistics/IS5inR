...
# Samples of 100
set.seed(12452)
gf_histogram(~ birthweight, data = sample(Births, size = 100), binwidth = 200, center = 100, fill = 5) %>%
  gf_histogram(~ birthweight, data = sample(Births, size = 100), binwidth = 200, center = 100, fill = 4) %>%
...
# Samples of 250
set.seed(12452)
gf_histogram(~ birthweight, data = sample(Births, size = 250), binwidth = 125, center = 62.5, fill = 5) %>%
  gf_histogram(~ birthweight, data = sample(Births, size = 250), binwidth = 125, center = 62.5, fill = 4) %>%
...
# Samples of 1000
set.seed(12452)
gf_histogram(~ birthweight, data = sample(Births, size = 1000), binwidth = 200, center = 100, fill = 5) %>%
  gf_histogram(~ birthweight, data = sample(Births, size = 1000), binwidth = 200, center = 100, fill = 4) %>%
