...
Jitter adds some random noise to allow easier observation of values that are shared by more than one type of breakfast cereal.  
...
We can use `group_by()` and `summarise()` together to find summary values of data.  
