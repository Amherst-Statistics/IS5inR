...
male_admits <- c(512, 313, 120, 138, 53, 22)
female_admits <- c(89, 17, 202, 131, 94, 24)
male_percent <- c(.621, .602, .369, .331, .277, .059)
female_percent <- c(.824, .680, .341, .349, .239, .070)
Berk <- data.frame(school, male_admits, female_admits, male_percent, female_percent)
Berk
```
