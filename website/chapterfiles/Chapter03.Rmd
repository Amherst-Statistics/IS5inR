...
XX MC please add page refs throughout this document
...
```{r}
# XX MC data are provided in table on the bottom of page 80: please create this on the fly as done in some of the prior texts
```
