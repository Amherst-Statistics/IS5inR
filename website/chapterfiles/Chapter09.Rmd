...
XX Generate number table on page 277
...
RealEstate <- read_csv("http://nhorton.people.amherst.edu/is5/data/Real_Estate.csv") %>%
  clean_names()
msummary(lm(price ~ living_area + bedrooms, data = RealEstate)) # save this as an object for a make fun for a predicted value (off by one to predict slope)
```
