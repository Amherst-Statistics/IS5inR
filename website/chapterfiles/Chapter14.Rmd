...
Here, the `do()` function finds the mean of a sample of 100 Babies weights 10,000 times.  
...
Here, the `do()` functions find the mean of a samples of 10, 50, and 200 CEO compensations 1,000 times.  
